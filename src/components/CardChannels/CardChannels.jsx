                        ...
                        <Link href={item.channel_facebook} passHref   >
                            <a target="_blank" rel="noopener noreferrer" className='m-1' >
                                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 9.55304C0 14.2761 3.43029 18.2036 7.91667 19V12.1386H5.54167V9.5H7.91667V7.38863C7.91667 5.01363 9.44696 3.69471 11.6114 3.69471C12.297 3.69471 13.0364 3.8 13.722 3.90529V6.33333H12.5083C11.347 6.33333 11.0833 6.91363 11.0833 7.65304V9.5H13.6167L13.1947 12.1386H11.0833V19C15.5697 18.2036 19 14.2769 19 9.55304C19 4.29875 14.725 0 9.5 0C4.275 0 0 4.29875 0 9.55304Z" fill="#27318D"/>
                                </svg>
                            </a>
                        </Link>
                    }
